def pred(mytexts):
    #Input : a list of texts in the form of strings.

    #Output : 3 lists of same size as the input, each containing, for each input text:
    ...
    K.clear_session()
    # output
    return (predictions,sentences_list,attentions)
